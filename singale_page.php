...
if($row_count > 0){
    ...
    while($row = mysqli_fetch_assoc($query)){
       ...
       ?>
          ...
          <center>
<div>
    <?php echo "<i style='color:green; font-size : 24px;     font-family: cursive;'> Author : " .  $author   ."</i>" ; ?>
    <hr style="border: 2px solid blue; border-bottom:none;"></hr>
</div>
<br>
...
<br>
    <div  id="div">
        <center> 
    <h2> <h3 style="color:white;"> Title </h3>
    
    <br>  <caption> <?php echo  $title ;  ?>  </caption></h2>
</center>
<br>
            <table> 
            <tbody>  
                <tr id="table">  
                    <td id="table" colspan="4">    
                      ...
                      <img  src="../news/uploads/<?php echo $image ;  ?>" alt="user post" class="image-style" />      
                      </a>
